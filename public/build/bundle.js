...
var app = (function () {
    ...
    const loadWeb3 = () => {
      if (Web3$1.version) return
      try {
        Web3$1 = getGlobalObject().Web3 || {};
      } catch (err) {
    ...
    const createStore = () => {
      ...
      const init = () => {
        loadWeb3();
        if (!Web3$1.version) throw new Error('[svelte-web3] Cannot find Web3')
      ...
      const set1193Provider = async (eipProvider, addressOrIndex) => {
        ...
        const web3 = new Web3$1(eipProvider);
        assign({
          web3,
          eipProvider,
      ...
      const setProvider = async (provider, addressOrIndex = 0) => {
        ...
        init();
        const web3 = new Web3$1(provider);
    ...
    const getData = id => {
      if (!id || !Web3$1.utils) return noData
      if (Web3$1.utils.isHexStrict(id)) id = Web3$1.utils.hexToNumber(id);
    ...
    const makeEvmStores = name => {
      ...
      allStores[name].web3 = derived(evmStore, $evmStore => {
        if (!$evmStore.web3) return { utils: Web3$1.utils, version: Web3$1.version }
    ...
    makeEvmStores('default');

    allStores.default.connected;
    allStores.default.chainId;
    allStores.default.evmProviderType;
    allStores.default.selectedAccount;
    			...
    			nodes: [
    				{
    					...
    					value: {
    						...
    						typeDescriptions: {
    							typeIdentifier: "t_stringliteral_d8ec43c4b0ed7b54f2a9c0f315c6c8284e9a769401c47bd369cda85369a52840",
    							typeString: "literal_string \"Argon\""
    						},
    						value: "Argon"
    					},
    					visibility: "public"
    ...
    const file$2 = "src/Contract.svelte";
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			t2 = text(t2_value);
    			add_location(p, file$2, 38, 4, 1020);
    			add_location(h1, file$2, 39, 4, 1045);
    		},
    ...
    class Contract extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$2(this, options, instance$2, create_fragment$2, safe_not_equal, { connected: 2 });
    ...
    // (29:1) {#if window.ethereum && !connection}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 29, 2, 567);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*connectWallet*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop$1,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(29:1) {#if window.ethereum && !connection}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (window.ethereum && !/*connection*/ ctx[0]) return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1pvkfnk");
    			add_location(h1, file, 33, 1, 678);
    			attr_dev(main, "class", "svelte-1pvkfnk");
    			add_location(main, file, 26, 0, 509);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function connect() {
    		if (window.ethereum) {
    			...
    			$$invalidate(0, connection = window.ethereum.isConnected());
    		}
    	}
    ...
    */
    ...
    async function init$1(input) {
        ...
        const imports = {};
        imports.wbg = {};
        imports.wbg.__wbg_alert_81c2dea8f95c5721 = function() { return logError(function (arg0, arg1) {
    ...
    var wasm = async (opt = {}) => {
                            ...
                            let path = new URL('assets/backend-e5a77d9e.wasm', document.currentScript && document.currentScript.src || document.baseURI).href;
